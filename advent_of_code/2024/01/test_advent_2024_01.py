import pytest
from advent_2024_01 import find_total_distance, get_lists, calculate_similarity, single_similarity


@pytest.mark.parametrize('list_a,list_b,expected', [
...
def test_get_lists():
    list_a, list_b = get_lists('advent_2024_01_example.txt')
